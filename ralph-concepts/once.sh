...
# Usage: ./ralph-concepts/once.sh [concept-id] [--model <slug>]
#
# concept-id (optional): generate a specific concept by id, e.g. 06-qkv-attention
#                        If omitted, picks the first unchecked item in plan.md.
#
# Examples:
#   ./ralph-concepts/once.sh                        # next in queue
#   ./ralph-concepts/once.sh 06-qkv-attention       # specific concept
#   ./ralph-concepts/once.sh 16-lora --model claude-sonnet-4
...
AGENT_TIMEOUT_SEC="${RALPH_CONCEPTS_TIMEOUT:-3600}"
TARGET_CONCEPT=""
...
[[ -f "$PLAN" ]] || {
  echo "Missing $PLAN — run ./ralph-concepts/scaffold.sh first" >&2
  exit 1
}
...
" >&2
  ...
  HTML_PATH="$PREP_ROOT/ai-engineering/concepts/${TARGET_CONCEPT}.html"
  if [[ -f "$HTML_PATH" ]]; then
...
The file should be at: $PREP_ROOT/ai-engineering/concepts/${TARGET_CONCEPT}.html
Mark it as done in ralph-concepts/plan.md even if it was already checked."
else
  DISPLAY_CONCEPT="(next in queue)"
  TARGET_INSTRUCTION="Pick the FIRST unchecked item from the ## Next section of ralph-concepts/plan.md."
fi

echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "Ralph Concepts — concept: $DISPLAY_CONCEPT"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "Log: $LOG_FILE" >&2
