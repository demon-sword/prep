...
# Usage: ./ralph-tts/scaffold.sh
# Builds ralph-tts/plan.md from concepts.json.
...
plan = f"""# Plan: Text-to-Speech & Voice AI Concepts
...
print(f"Scaffolded ralph-tts plan")
...
if remaining > 0:
    print("Next:")
    print(f"  ./ralph-tts/once.sh")
    print(f"  ./ralph-tts/loop.sh {remaining + 5}")
else:
