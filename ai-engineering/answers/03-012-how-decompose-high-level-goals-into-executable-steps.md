...
1. Planner call (GPT-4o, ~2K tokens): produces 6-step plan as JSON with success criteria.
2. Executor loop: each step calls one tool (GitHub API read, linter, security scanner, GPT-4o-mini summarizer).
